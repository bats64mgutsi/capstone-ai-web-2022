    ...
    <section class="w-11/12 mx-auto">
        <div class="flex">
            ...
            <div v-if="profile" class="grow flex flex-col justify-center">
                ...
                <span class="bg-gray-100 text-gray-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-gray-300 mb-2">Institution: <span class="text-blue-700">{{profile.institution.name}}</span></span>
