        ...
        <div class="flex flex-row justify-between items-center mb-3">
            <div class="bg-white dark:bg-gray-900 flex flex-row items-center">
                ...
                <div class="relative mt-1">
                    ...
                    <input type="text" id="table-search" @input="handleSearchFileInput()" class="block p-2 pl-10 w-80 text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search for subfields">
                </div>
            </div>
        </div>
...
const setSearchedContent = () => {
    searchedContent.value = JSON.parse(JSON.stringify(stats));
}
