<template>
    <div>
        ...
        <div id="large-modal" tabindex="-1" data-modal-placement="top-center" class="hidden overflow-y-auto overflow-x-fixed fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full">
...
import { ref } from "vue";
import { uploadNrfResearchers } from "../../pages/util";
